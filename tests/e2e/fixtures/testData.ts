export interface BranchBaselineData {
  name: string;
  shortName: string;
  students: number;
  gender: {
...
export const BASELINE_TEST_DATA: Record<string, BranchBaselineData> = {
  thakur: {
    name: 'Thakur Complex',
    shortName: 'Thakur',
    students: 108,
...
export interface ReferenceBaselineData {
  singapore: {
...
export const REFERENCE_TEST_DATA: ReferenceBaselineData = {
  singapore: {
...
export const REFERENCE_DATA = REFERENCE_TEST_DATA;

export interface PRBaselineData {
  cognitive: {
...
export const PR_TEST_DATA: PRBaselineData = {
  cognitive: {
...
export const PR_DATA = PR_TEST_DATA;
